...
_Forked from_ [_Tony Kipkemboi repository_](https://github.com/tonykipkemboi/trip_planner_agent) and used Ollama and ScrapingAnt instead of OpenAI and Serper
